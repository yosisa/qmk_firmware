...
[_QWERTY] = LAYOUT( \
  ...
  KC_BSLS, KC_Z,    KC_X,    KC_C,    KC_V,            KC_B,   KC_LBRC, KC_RBRC, KC_N,   KC_M,            KC_COMM, KC_DOT,  KC_SLSH, KC_QUOT , \
                 KC_LEFT, KC_LGUI,    CTL_T(KC_LANG2), KC_SPC, LOWER,     RAISE, KC_ENT, SFT_T(KC_LANG1), KC_LALT, KC_RGHT \
),
 ...
 */
[_LOWER] = LAYOUT( \
  KC_TILD, KC_EXLM, KC_AT,   KC_UP,   KC_DLR,  KC_PERC,                   KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, _______, \
  KC_TAB,  KC_EXLM, KC_AT,   KC_UP,   KC_DLR,  KC_PGUP,                   KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_DEL,  \
  KC_LCTL, KC_F1,   KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN,                   KC_F6,   KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_PIPE, \
