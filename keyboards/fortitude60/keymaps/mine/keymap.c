...
[_QWERTY] = LAYOUT( \
  ...
  KC_BSLS, KC_Z,    KC_X,    KC_C,  KC_V,  KC_B, KC_ENT, KC_SPC, KC_N,            KC_M,  KC_COMM, KC_DOT,  KC_SLSH, KC_QUOT , \
                 KC_LEFT, KC_LGUI, LOWER, KC_LCTL,  KC_SPC,  KC_ENT, SFT_T(KC_LANG1), RAISE, KC_LALT, KC_RGHT \
),
