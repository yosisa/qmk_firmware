...
[_QWERTY] = {
  ...
  {KC_GRV,               KC_BSLS, KC_LALT, KC_LGUI, LT(_LOWER, KC_LANG2), SFT_T(KC_SPC), SFT_T(KC_MINS), LT(_RAISE, KC_LANG1), KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT}
},
 ...
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * | Ctrl |      | Left | Down |Right |Pg Dn |      |      |  F5  |  F6  |  F7  |  F8  |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * |      | CADwn| Home |      |  End |      |      |      |  F9  |  F10 |  F11 |  F12 |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |      |      |Space |   _  |Shift | Next | Vol- | Vol+ | Play |
 * `-----------------------------------------------------------------------------------'
 */
[_LOWER] = {
  {KC_GRV,  _______,             _______, KC_UP,   _______, KC_PGUP, _______, _______, KC_F1,   KC_F2,   KC_F3,   KC_F4  },
  {KC_LCTL, _______,             KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN, _______, _______, KC_F5,   KC_F6,   KC_F7,   KC_F8  },
  {_______, LGUI(LALT(KC_DOWN)), KC_HOME, _______, KC_END,  _______, _______, _______, KC_F9,   KC_F10,  KC_F11,  KC_F12 },
  {_______, _______,             KC_LALT, KC_LGUI, _______, KC_SPC,  KC_UNDS, KC_LSFT, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY}
},
...
[_RAISE] = {
  ...
  {KC_MUTE, _______,   _______, _______, _______, _______, KC_MINS, KC_PLUS, KC_LCBR, KC_RCBR, KC_LBRC, KC_RBRC},
  {KC_VOLD, KC_VOLU,   KC_LALT, KC_LGUI, KC_LSFT, KC_SPC,  _______, _______, _______, _______, _______, _______}
},
