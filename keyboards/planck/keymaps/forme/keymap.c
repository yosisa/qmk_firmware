 ...
 * |   \  |   Z  |   X  |   C  |   V  |   B  |   N  |   M  |   ,  |   .  |   /  | Down |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |   `  |   \  | Alt  | GUI  |Lower |Space | Bksp |Raise |   '  | Left |Right |  Up  |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = {
  ...
  {KC_GRV,               KC_BSLS, KC_LALT, KC_LGUI, LT(_LOWER, KC_LANG2), SFT_T(KC_SPC), SFT_T(KC_BSPC), LT(_RAISE, KC_LANG1), KC_QUOT, KC_LEFT, KC_RGHT, KC_DOWN}
},
 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |      |      |Space | Bksp |Shift | Next | Vol- | Vol+ | Play |
 * `-----------------------------------------------------------------------------------'
 */
[_LOWER] = {
  ...
  {_______, _______,             KC_LALT, KC_LGUI, _______, KC_SPC,  KC_BSPC, KC_LSFT, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY}
},
 ...
 * | Mute |   |  |      |      |      |      |   -  |   +  |   {  |   }  |   [  |  ]   |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Vol- | Vol+ | Alt  | GUI  |Shift |Space | Bksp |      |      |      |      |      |
 * `-----------------------------------------------------------------------------------'
 */
[_RAISE] = {
  ...
  {KC_VOLD, KC_VOLU, KC_LALT, KC_LGUI, KC_LSFT, KC_SPC,  KC_BSPC, _______, _______, _______, _______, _______}
},
